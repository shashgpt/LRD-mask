...
class Construct_covid19_dataset(object):
    ...
    def covid_dataset_thresholds(self): # Code to calculate the Sentiment and VADER thresholds for the tweets
        ...
        emoji_score_table = pd.read_csv("datasets/Covid-19_tweets/dataset/EmoTag1200-scores.csv")
        ...
        for i in range(1, 400):
            ...
            with open("datasets/Covid-19_tweets/dataset"+"/corona_tweets_"+i+"/"+file_name,'r') as inf:
            ...
            with open("datasets/Covid-19_tweets/dataset"+"/corona_tweets_"+i+"/corona_tweets_"+i+"_data.txt",'r') as inf:
                print("\n")
    ...
    def covid_dataset(self, process_no, start, stop): # Code to label the tweets with sentiment labels
        ...
        for i in range(start, stop+1):
            ...
            self.counters = {"tweets_in_corpus":0,
            ...
            if not os.path.exists("datasets/Covid-19_tweets/preprocessed_dataset/corona_tweets_"+i):
                os.makedirs("datasets/Covid-19_tweets/preprocessed_dataset/corona_tweets_"+i)
            ...
            log_file = open("datasets/Covid-19_tweets/preprocessed_dataset/corona_tweets_"+i+"/"+log_file_name, "w")
                ...
                with tqdm(desc = file_name, total = no_of_lines) as pbar:
                    ...
                    for line in inf:
                        ...
                        try:
                            ...
                            print("roberta sentiment: ", roberta_sentiment_label)
                            ...
                            with open("datasets/Covid-19_tweets/preprocessed_dataset/counters_"+i+".pickle", 'wb') as handle:
            ...
            with open("datasets/Covid-19_tweets/preprocessed_dataset/corona_tweets_"+i+"/preprocessed_data.pickle", 'wb') as handle:

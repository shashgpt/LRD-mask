...
if __name__=='__main__':
    ...
    # tf.random.set_random_seed(config["seed_value"])
    ...
    # Train model
    print("\nTraining")
    model = Train(config, tokenizer).train_model(model, train_dataset, val_datasets, test_datasets)
    ...
    # Test model
    print("\nEvaluation")
    Evaluation(config).evaluate_model(model, test_datasets)

    # LIME explanations
    print("\nLIME explanations")
    Lime_explanations(config, model).create_lime_explanations()
